...
<style>
    .carousel-inner img {
        width: 100%;
        height: 550px;
        object-fit: cover; /* Prevents stretching and keeps the aspect ratio */
        opacity: 0.9;
    }
        ...
        <div class="row mt-3  justify-content-center">
            <div class="col-md-4 d-flex justify-content-center my-3">
                <div class="card" style="width: 18rem;">
                    <img src="assets/python.jpg" class="card-img-top img-fluid" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4 d-flex justify-content-center my-3">
                <div class="card" style="width: 18rem;">
                    <img src="assets/js.png" class="card-img-top img-fluid" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-primary">View Thread</a>
